...
## Purpose
Operational cue sheet for Eric/Greg/operator to run the 5-minute live walkthrough with deterministic handoffs.
...
## Owner roles
- `Eric`: Narrative frame, technical framing lines, pilot close.
- `Greg`: Product operation, overlays, pass output walkthrough.
- `Operator backup`: Executes fallback assets on abort conditions.
